      ...
      <div className="bg-card rounded-2xl p-5 mb-6 shadow-soft border border-border/50">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <Button variant="default" size="sm">📍 Rotas</Button>
            <Button variant="ghost" size="sm">🔥 Mapa de calor</Button>
            <Button variant="ghost" size="sm">⬡ Aglomerados</Button>
            <div className="border-l border-border mx-2" />
            <Button variant="outline" size="sm">🚦 Tráfego</Button>
            <Button variant="outline" size="sm">⛶ Tela cheia</Button>
          </div>
        </div>
        ...
        <div className="h-64 bg-muted/30 rounded-xl flex items-center justify-center mb-4">
          <div className="text-center text-muted-foreground">
            ...
            <p className="text-sm">Mapa de entregas em tempo real</p>
            <p className="text-xs">Região metropolitana</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 text-center">
          ...
          <div>
            <p className="text-2xl font-bold text-card-foreground">127,4 milhas</p>
          ...
          <div>
            <p className="text-2xl font-bold text-card-foreground">$ 2.340</p>
            <p className="text-xs text-muted-foreground">Preço do combustível hoje</p>
          </div>
        </div>
      </div>
